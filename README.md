...
If you are a developer or tester, you can also build and run the app from source using Flutter (see the main README for instructions) [Here](https://github.com/edwards698/Seed-Studio-DigiSave/tree/main/firmware)
